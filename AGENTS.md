...
This file is the quick-reference operating contract for socket2-kotlin. The longer
...
socket2-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`socket2`](https://crates.io/crates/socket2). Upstream Rust is the behavioral oracle while the
